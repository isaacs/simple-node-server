...
process.mixin(SNS.prototype, {
  ...
  processRequest : function SNS_process (req, res) {
    this.emit("request", SNSProcessor(this, req, res));
    return this;
  },
...
function SNSProcessor (server, req, res) {
  var p = server.processors.pop();
  if (!p && this instanceof SNSProcessor) p = this;
  else return new SNSProcessor(server, req, res);
